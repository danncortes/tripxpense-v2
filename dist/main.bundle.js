...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__travel_travel_edit_travel_edit_component__ = __webpack_require__("../../../../../src/app/travel/travel-edit/travel-edit.component.ts");
    ...
    AppModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_30__travel_travel_edit_travel_edit_component__["a" /* TravelEditComponent */]
            ],
            imports: [
                //Modules
...
var TravelService = (function () {
    ...
    TravelService.prototype.update = function (formData, travel_id) {
        return this.http.put(__WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].apiUrl + '/travel/update/' + travel_id, formData)
            .map(function (data) { return data.json(); });
    };
...
/***/ "../../../../../src/app/travel/travel-edit/travel-edit.component.html":
/***/ (function(module, exports) {

module.exports = "<md-toolbar class=\"dialog-header\">\n    <span>Edit a Travel</span>\n</md-toolbar>\n<section class=\"trip-md-dialog-container\">\n\n    <form action=\"\" [formGroup]=\"editTravelForm\" (ngSubmit)=\"editTravel(editTravelForm.value)\" fxLayoutWrap fxLayout=\"row\">\n        <md-input-container fxFlex=\"100\">\n            <input mdInput type=\"text\" placeholder=\"Name\" [formControl]=\"editTravelForm.controls['name']\" [ngModel]=\"travel.name\" required>\n            <md-error>\n                <span *ngIf=\"editTravelForm.controls.name.invalid\">A name is required</span>\n            </md-error>\n        </md-input-container>\n\n        <div fxLayoutWrap fxLayout=\"row\" fxLayoutAlign=\"space-between start\" fxFlex=\"100\">\n            <md-input-container fxFlex=\"45\">\n                <input mdInput [ngModel]=\"travel.start_date\" [mdDatepicker]=\"startDatePicker\" [formControl]=\"editTravelForm.controls['start_date']\" placeholder=\"Choose an start date\" required>\n                <button mdSuffix [mdDatepickerToggle]=\"startDatePicker\"></button>\n                <md-error>\n                    <span *ngIf=\"editTravelForm.controls.start_date.invalid\">As start date is required</span>\n                </md-error>\n            </md-input-container>\n            <md-datepicker #startDatePicker></md-datepicker>\n\n            <md-input-container fxFlex=\"45\">\n                <input mdInput [ngModel]=\"travel.finish_date\" [mdDatepicker]=\"endDatePicker\" [formControl]=\"editTravelForm.controls['finish_date']\" placeholder=\"Choose a finish date\" required>\n                <button mdSuffix [mdDatepickerToggle]=\"endDatePicker\"></button>\n                <md-error>\n                    <span *ngIf=\"editTravelForm.controls.finish_date.invalid\">As finish date is required</span>\n                </md-error>\n            </md-input-container>\n            <md-datepicker #endDatePicker></md-datepicker>\n        </div>\n\n\n        <div fxLayoutWrap fxLayout=\"row\" fxLayoutAlign=\"space-between start\" fxFlex=\"100\">\n            <md-input-container fxFlex=\"30\">\n                <input mdInput min=\"0\" [ngModel]=\"travel.start_tdc_balance\" type=\"number\" placeholder=\"Credit Card Balance\" [formControl]=\"editTravelForm.controls['start_tdc_balance']\">\n            </md-input-container>\n            <md-input-container fxFlex=\"30\">\n                <input mdInput min=\"0\" [ngModel]=\"travel.start_cash_balance\" type=\"number\" placeholder=\"Cash Balance\" [formControl]=\"editTravelForm.controls['start_cash_balance']\">\n            </md-input-container>\n            <md-input-container fxFlex=\"30\">\n                <input mdInput min=\"0\" [ngModel]=\"travel.start_tdd_balance\" type=\"number\" placeholder=\"Debit Card Balance\" [formControl]=\"editTravelForm.controls['start_tdd_balance']\">\n            </md-input-container>\n        </div>\n\n\n        <section fxFlex=\"100\" fxLayout=\"row\" fxLayoutAlign=\"end start\">\n            <button type=\"submit\" md-raised-button color=\"primary\" [disabled]=\"editTravelForm.invalid || processing\">\n        <span *ngIf=\"!this.processing\">Update</span>\n        <md-spinner *ngIf=\"this.processing\"></md-spinner>\n      </button>\n        </section>\n    </form>\n</section>"

/***/ }),

/***/ "../../../../../src/app/travel/travel-edit/travel-edit.component.scss":
/***/ (function(module, exports, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_toast_toast_service__ = __webpack_require__("../../../../../src/app/services/toast/toast.service.ts");
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TravelEditComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TravelEditComponent = (function () {
    function TravelEditComponent(dialogRef, formBuilder, travelService, router, toastService) {
        this.dialogRef = dialogRef;
        this.travelService = travelService;
        this.router = router;
        this.toastService = toastService;
    ...
    TravelEditComponent.prototype.ngOnInit = function () {
    ...
    TravelEditComponent.prototype.editTravel = function (formData) {
        var _this = this;
        if (this.hasOperations) {
        ...
        var travel_id = this.travel.id;
        this.processing = true;
        this.travelService.update(formData, travel_id)
            .subscribe(function (data) {
            _this.processing = false;
            _this.dialogRef.close(true);
            _this.toastService.success({ message: 'Travel Saved!' });
        }, function (err) {
            _this.processing = false;
            _this.dialogRef.close(false);
            _this.toastService.error({ message: 'An error has occur!' });
    ...
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ], TravelEditComponent.prototype, "travel", void 0);
    TravelEditComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-travel-edit',
            template: __webpack_require__("../../../../../src/app/travel/travel-edit/travel-edit.component.html"),
            styles: [__webpack_require__("../../../../../src/app/travel/travel-edit/travel-edit.component.scss")],
            providers: [
                __WEBPACK_IMPORTED_MODULE_3__services_travel_travel_service__["a" /* TravelService */],
                __WEBPACK_IMPORTED_MODULE_5__services_toast_toast_service__["a" /* ToastService */]
            ]
    ...
    return TravelEditComponent;
    var _a, _b, _c, _d, _e;
}());

//# sourceMappingURL=travel-edit.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_material__ = __webpack_require__("../../../material/@angular/material.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__confirm_dialog_confirm_dialog_component__ = __webpack_require__("../../../../../src/app/confirm-dialog/confirm-dialog.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__travel_edit_travel_edit_component__ = __webpack_require__("../../../../../src/app/travel/travel-edit/travel-edit.component.ts");
...
var TravelItemComponent = (function () {
    ...
    TravelItemComponent.prototype.editTravel = function (travel) {
        var _this = this;
        var dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_5__travel_edit_travel_edit_component__["a" /* TravelEditComponent */], {
            width: '500px'
        });
...
var environment = {
    production: true,
    envName: 'prod',
    apiUrl: 'http://api.tripxpense.com/public'
};
